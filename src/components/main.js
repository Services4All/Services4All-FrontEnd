							...
							<Grid container spacing={4}>
								...
								<Grid item key="3" xs={12} sm={6} md={4}>
									<Card className={useStyles().card}>
										<CardMedia
											className={useStyles().cardMedia}
											image = "https://images.vexels.com/media/users/3/147722/isolated/preview/618e5b270ddb606dae6fa57689bfe3cd-logotipo-de-servicio-mec-aacute-nico-de-autom-oacute-viles-by-vexels.png"
											title ="Image title"
										/>
										<CardContent className={useStyles().cardContent}>
											<Typography gutterBottom variant="h5" component="h2">
								...
								<Grid item key="4" xs={12} sm={6} md={4}>
									<Card className={useStyles().card}>
										<CardMedia
											className={useStyles().cardMedia}
											image = "https://i.pinimg.com/474x/2c/94/dc/2c94dca3d298d6bffad5402deae4a166.jpg"
											title ="Image title"
										/>
										<CardContent className={useStyles().cardContent}>
											<Typography gutterBottom variant="h5" component="h2">
								...
								<Grid item key="6" xs={12} sm={6} md={4}>
									<Card className={useStyles().card}>
										<CardMedia
											className={useStyles().cardMedia}
											image = "https://images.vexels.com/media/users/3/143028/isolated/preview/fca3043920fa2ff5d59aa0cedb758b75-zapatos-de-ropa-by-vexels.png"
											title ="Image title"
										/>
										<CardContent className={useStyles().cardContent}>
											<Typography gutterBottom variant="h5" component="h2">
